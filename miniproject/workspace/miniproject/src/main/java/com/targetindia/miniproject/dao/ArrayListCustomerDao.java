...
public class ArrayListCustomerDao implements CustomerDao {
    ...
    public ArrayListCustomerDao() {
        customers.add(new Customer(1, "Dell Goldfinch", "Shijiazhai", "dgoldfinch0@netlog.com", "8609657940"));
        customers.add(new Customer(2, "Robb Groven","Tabu","rgroven1@bandcamp.com","5208396145"));
    }
